...
const projects: TypeProject[] = [
  ...
  // {
  //   title: 'Trello Clone',
  //   description: 'Clone del famoso software Trello Clone',
  ...
  //   technologies: ['Astro', 'Tailwind', 'Node', 'Express', 'Copilot'],
  //   proyectType: 'frontend',
  //   featured: true,
  //   stats: {
  //     stars: 24,
  ...
  //   technologies: ['Next.js', 'React', 'TypeScript', 'CSS', 'GSAP', 'Vite'],
  //   proyectType: 'frontend',
  //   featured: true,
  ...
  //   technologies: ['Nest', 'TypeOrm', 'PostgreSQL', 'Docker', 'Passport'],
  //   proyectType: 'backend',
  //   featured: false,
  ...
  //   technologies: ['React', 'TypeScript', 'Zustand', 'Tailwind', 'Lucide React'],
  //   proyectType: 'frontend',
  //   featured: false,
  ...
  //   technologies: ['Node', 'ExpressJS', 'TypeScript', 'MongoDB', 'Railway'],
  //   proyectType: 'backend',
  //   featured: false,
  ...
  //   technologies: ['Node', 'ExpressJS', 'TypeScript', 'React', 'MonogDB'],
  ...
  //   technologies: ['Node', 'JavaScript', 'Cors', 'body-parser', 'cors', 'dotenv', 'multer'],
  //   proyectType: 'backend',
  //   featured: false,

      ...
      <div className="p-6">
        <div className="flex justify-between items-start">
          ...
          {project.status === 'completed' ? (
            ...
            <LoaderCircle className="w-6 h-& text-yellow-500 animate-spin" />
          )}
        </div>
      </div>
        ...
        >
          {project.github && (
            <a href={project.github} target="_blank">
              <button
                className="p-2 rounded-lg ounded-full bg-black/50 backdrop-blur-sm border-2 border-green-900/50 text-green-500 transition-colors"

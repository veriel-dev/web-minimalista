...
export const FormSendEmailMatrix = () => {
  const {
    contactSetion: { form },
  } = homePage;
  ...
  return (
    <div className="w-full max-w-md mx-auto rounded-lg shadow-lg overflow-hidden border-2 border-green-400/70 bg-black/50 backdrop-blur-sm">
      <div className="p-6">
        <div className="flex items-center gap-2 mb-6">
          <Mail className="h-5 w-5 text-green-500" />
          <h2 className="text-xl text-green-500 font-bold">{form.title}</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <textarea
              ...
              rows={4}
              className={cn(
                'w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors resize-none bg-transparent text-green-500',
                errors.message
                  ? 'border-red-500'
          ...
          <button
            ...
            className={cn(
              ...
              isSubmitting
                ...
                : 'bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-600',
            )}
          >

...
export const homePage = {
    ...
    skillsSection: {
        ...
        technologies: {
            frontend: [
                {
                    name: "React",
                    description: "Biblioteca líder para construcción de interfaces modernas y aplicaciones SPA",
                    level: 85,
                },
                {
                    name: "Astro",
                    description: "Framework moderno para sitios web de alto rendimiento con hidratación parcial",
                    level: 50,
                },
                {
                    name: "Next",
            ...
            backend: [
                {
                    name: "Node",
                    description: "Runtime JavaScript para backend de alto rendimiento y aplicaciones en tiempo real",
                    level: 65,
                },
                {
                    name: "Spring",
    ...
    contactSetion: {
        ...
        description: "Espero que hayas disfrutado explorando mi trabajo y que hayas obtenido una idea clara de mis habilidades y experiencia.",
        form: {
